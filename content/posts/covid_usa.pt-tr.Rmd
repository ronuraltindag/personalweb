...
need <- c('glue', 'dplyr','readxl', 'haven', 'ggplot2', 'utils','httr', 'readr',
          'tidyr','zoo','ggrepel','ggthemes','kableExtra','gganimate','gifski','ftplottools')
...
g1 <- df1 %>%
  ...
  ggplot(aes(y=c.cases/1000,x=state, colour=state)) + 
  ...
  labs(title = 'Cumulative # of COVID cases by county \n {frame_time}', x = ' ', y = '') +
  theme(legend.position = 'none') +
