...
```{r read.df, echo=FALSE, error=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE}
...
g1 <- df1 %>%
  ...
  ggplot(aes(y=cases/1000,x=state, colour=state)) + 
  ...
  labs(title = '# of COVID daily cases by county \n {frame_time}', x = ' ', y = '') +
  theme(legend.position = 'none') +
