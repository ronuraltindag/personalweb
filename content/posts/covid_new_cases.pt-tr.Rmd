...
### Son Güncelleme: 13 Agustos  2020 
...
pal <- c('#377eb8','#4daf4a','#ff7f00','#a65628','#f781bf','#e41a1c')
...
g2 <- df2 %>% 
  ...
  subtitle = '3 günlük hareketli ortalama, son güncelleme: 8 Agustos 2020 ', x=' ',y='') +
