...
sc1 <- c(1,2,5,10,20,50,100,200,400,800,1500,3000,6000,10000,15000)
...
g2 <- df2 %>% 
  ...
  geom_segment(aes(xend = max.n-4, yend = log(cdeaths), colour = country), linetype = 2) + 
  geom_point(size = 3,aes(colour=country)) + 
  geom_text(aes(x = max.n-3, label = country, colour=country), hjust = 0) + 
